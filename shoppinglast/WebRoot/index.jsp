...
<%
 List<Goods> bargainGoods = (List<Goods>)request.getAttribute("bargainGoods");
    
 if(bargainGoods == null){
  request.getRequestDispatcher("./showBargainGoods.do").forward(request, response);
 return;}
%>
<%
 List<Goods> newGoods = (List<Goods>)request.getAttribute("newGoods");
 if(newGoods == null){
 request.getRequestDispatcher("./showNewGoods.do").forward(request, response);
 return;}
%>
<!-- 拿到大类小类的树，注意servlet的url -->
 <c:if test="${empty requestScope.sortVos}">
   	 <jsp:forward page="showSortTree.do?url=index.jsp"></jsp:forward>
 </c:if>
<c:if test="${empty ads}">
<jsp:forward page="showAllAds.do?url=index.jsp"></jsp:forward>
</c:if>
	...
	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
        ...
        <td height="98" align="center" background="images/shop_17.gif">		 
         <!-- 会员登陆面板 -->
		  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
			...
			<!-- 这里要设置一个div -->  <div class="loginTable"></div>
				</td>
            </tr>
          </table>
          <!-- 会员登陆面板 -->
      ...
      <table width="100%" height="155"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <table id="showNotice" width="88%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" height="151"  border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <!-- 销售排行循环开始 -->
           <!-- 给销售排行一个id 直接调用global_guoguo_goodsale.js -->
          <table id="showGoodSale" width="88%"  border="0" cellspacing="0" cellpadding="0">
          </table>
    ...
    <td valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="search" method="post" action="searchGoods.do">
			...
			<tr>
	      <td width="90%">淘宝去：
				<select name="type_s" class="textarea"  id="ptype_s">
			   </select>
		<input type="checkbox" name="bargain_s">特 价<input type="checkbox" name="newGoods_s">新 品		
		<input type="text" class="txt_grey" size="24" name="content_s"> </td>
			  <td width="10%"><input type="submit" class="button white small"" value="搜索"></td>
			</tr>
			</table>
			</form>
			<!--搜索框结束-->
        ...
        <tr>
          <td width="69%" height="189" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr align="center" valign="top">
              <td height="134" colspan="2"><table width="100%" height="162"  border="0" cellpadding="0" cellspacing="0">
                <tr>
				 ...
				 <c:forEach  items="${bargainGoods}" var="bGood" begin="0" end="0"> 
				  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="95" align="center"><img src="images/goods/${bGood.name}.jpg" width="150" height="88"></td>
                    </tr>
                    <tr>
                      <td height="22" align="center" class="font2"><a href="./showGdetail.do?gid=${bGood.gid}">${bGood.name }</a></td>
                    </tr>
                    <tr>
                      <td height="20" align="center" style="text-decoration:line-through;">市场价：￥${bGood.marketprice } </td>
                    </tr>
                    <tr>
                      <td height="20" align="center" style="color:#FF0000">商城价：￥${bGood.nowprice }</td>
                    </tr>
                    <tr>
                      <td height="22" align="center">
                      <input type="button" class="button white small" value="购买" onClick="window.location.href='./cartAdd.do?gid=${bGood.gid}'">
                      &nbsp;<input type="button" class="button white small" value="收藏"  onclick="checkUserLogInToFavotice('${bGood.gid}')">
                      </td>
                    </tr>
                  </table>
                  </c:forEach>
                  ...
                  <td width="49%" valign="top">
				   <c:forEach  items="${bargainGoods}" var="bGood_2" begin="1" end="1">
				    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="95" align="center"><img src="images/goods/${bGood_2.name}.jpg" width="150" height="88"></td>
                      </tr>
                      <tr>
                        <td height="22" align="center" class="font2"><a href="./showGdetail.do?gid=${bGood_2.gid}">${bGood_2.name}</a></td>
                      </tr>
                      <tr>
                        <td height="20" align="center" style="text-decoration:line-through;">市场价：￥${bGood_2.marketprice}</td>
                      </tr>
                      <tr>
                        <td height="20" align="center" style="color:#FF0000">商城价：￥${bGood_2.nowprice}</td>
                      </tr>
                      <tr>
                        <td height="22" align="center">
                           <input type="button" class="button white small" value="购买" onclick="window.location.href='./cartAdd.do?gid=${bGood_2.gid}'">
                           &nbsp;<input type="button" class="button white small" value="收藏"  onclick="checkUserLogInToFavotice('${bGood_2.gid}')">
                        </td>
                      </tr>
                    </table>
                    </c:forEach>
            ...
            <table width="100%" height="76"  border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="2">
				<!-- 新品循环开始 -->
				<c:forEach items="${newGoods}" var="nGood" begin="0" end="4"> 
				<table width="100%" height="79"  border="0" cellpadding="0" cellspacing="0" class="tableBorder_B_dashed">
                  <tr>
                    <td width="33%" height="95" rowspan="2" align="center"><img src="images/goods/${nGood.name}.jpg" width="99" height="61"></td>
                    <td width="67%" class="font2"><a href="./showGdetail.do?gid=${nGood.gid }">${nGood.name}</a></td>
                  </tr>                  
                  <tr>
                    <td>￥${nGood.nowprice}(折扣：<fmt:formatNumber value="${nGood.discount}" pattern="#.#"/> ) </td>
                    <td align="right" valign="top">
                    <input type="button" class="button white small" onClick="window.location.href='./cartAdd.do?gid=${nGood.gid}'" value="购买">
                      &nbsp;<input type="button" class="button white small" value="收藏"  onclick="checkUserLogInToFavotice('${nGood.gid}')">
					</td>
                  </tr>
                </table>
                </c:forEach>
	     ...
	     <c:forEach   items="${sortVo.csort}" var="csort">
	       addtree('-'+"${csort.name}","type.jsp?gid=${csort.sid}",'_self');
            ...
            <table width="100%" height="119"  border="0" cellpadding="0" cellspacing="0" style="width: 205px;">
            <c:forEach items="${ads}" var="ad">
              <tr>
                <td height="70" align="center"><a href="${ad.aURL}"><img src="images/goods/${ad.exp}.jpg" width="150" height="60" ></a></td>
              </tr>
              </c:forEach>
            </table>
		 <!--右侧框架结束-->
  ...
  <tr>
	...
	<table width="100%" height="78"  border="0" align="center" cellpadding="-2" cellspacing="-2">
	  ...
	  <tr>
        ...
        <a    onclick="window.location.href='./manage/login.html'"><img src="images/bod1.gif" width="85" height="32"></a>
             <img src="images/bod2.gif" width="85" height="32">
