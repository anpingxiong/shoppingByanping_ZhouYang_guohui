<%@ page language="java" import="java.util.*,com.shopping.guoguo.pojo.*" pageEncoding="UTF-8"%>
<%@ include file="./include_head.jsp" %>
<c:if test="${empty pgoods}"><!-- 新品时 tag=2 -->
<jsp:forward page="./showGoodsPage.do?currentPage=1&tag=2"></jsp:forward>
</c:if>
          ...
          <td height="189" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <c:forEach items="${pgoods}" var="pgood">
			       <table width="98%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      <td width="37%" height="95" rowspan="5" align="center"><img src="images/goods/${pgood.name}.jpg" width="150" height="100"></td>
                      <td width="63%" height="27" class="font2"><a href="./showGdetail.do?gid=${pgood.gid}">${pgood.name}</a></td>
                    </tr>
                    <tr>
                      <td height="27">￥${pgood.nowprice}(折扣:<fmt:formatNumber value="${pgood.discount}" pattern="#.#"></fmt:formatNumber>) </td>
                    </tr>
                    <tr>
                      <td height="27">
                    ...
                    <tr>
                      <td><input type="button"  class="button white small" value="购买">&nbsp;&nbsp;
           ...
           <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<a href="./showGoodsPage.do?currentPage=1&tag=2">第一页</a>　
				<a href="./showGoodsPage.do?currentPage=${vo.currentPage-1}&tag=2">上一页</a>
				<!-- 判断 如果currentPage已经等于otalpage那么 currentpage就等于totalpage -->
				<c:if test="${vo.currentPage!=vo.totalPage}" >
				<a href="./showGoodsPage.do?currentPage=${vo.currentPage+1}&tag=2">下一页</a>　
				</c:if>
				 <c:if test="${vo.currentPage==vo.totalPage}" >
				<a href="./showGoodsPage.do?currentPage=${vo.totalPage}&tag=2">下一页</a>　
				</c:if>
				<a href="./showGoodsPage.do?currentPage=${vo.totalPage}&tag=2">最后一页&nbsp;</a>
