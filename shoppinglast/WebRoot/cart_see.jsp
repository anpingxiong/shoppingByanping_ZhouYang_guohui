			  ...
			  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td height="31">
                    ...
                    <input type="button" class="button white small" value="注册" onClick="window.location.href='register.html'">

                    &nbsp;

                    <input type="button" class="button white small" value="登录">                    

                    <input type="reset" class="button white small" value="重置">
      ...
      <tr>
        ...
        <td colspan="2" background="images/shop_16.gif">
			...
			<tr>
			  ...
			  <td width="15%"><input type="submit" class="button white small" value="搜索"></td>
...
<table width="90%"  border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td height="57" align="right"><input type="button" class="button white small" value="我要购买商品！" onClick="window.location.href='index.jsp'"></td>
