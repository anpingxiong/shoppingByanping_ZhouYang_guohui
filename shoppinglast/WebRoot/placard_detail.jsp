            ...
            <tr valign="top">
              <td height="134" align="center">
                  ...
                  <table width="96%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    ...
                    <tr>                     
                      <td width="95%" height="27" class="font1">${requestScope.notice.title}</td>
                    </tr>
                    <tr>                      
                      <td height="27">&nbsp;&nbsp;${requestScope.notice.content}</td>
                    </tr>
                    <tr>                      
                      <td height="27">发布日期：${requestScope.notice.pdate}</td>
                    </tr>
                    <tr><td height="27">过期日期：${requestScope.notice.overdate}</td></tr>
                    <tr>
                      <td align="center" ><input type="button" class="button white small " onClick="history.back(-1);" value="返回"></td>                      
                    </tr>
                  </table>
