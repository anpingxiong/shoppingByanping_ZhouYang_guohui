...
<table width="100%" height="126"  border="0" cellpadding="0" cellspacing="0">
      ...
      <form method="post" action="" name="modifygoods">

       <table width="534" height="77" border="0" align="center" cellpadding="0" cellspacing="0">

          <tr><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td><td valign="top"><br></td></tr><tr align="center" valign="middle">

            <td height="27" class="tableBorder_B1">编号</td>

            <td class="tableBorder_B1">商品名称</td>

            <td class="tableBorder_B1">市场价</td>

            <td class="tableBorder_B1">商城价</td>

            <td class="tableBorder_B1">折扣</td>

            <td class="tableBorder_B1">数量</td>
...
<c:forEach items="${requestScope.goods}" var="product">
<c:set var="sum" value="${sum+ product.good.marketprice*product.count}"></c:set>
<c:set var="sum1" value="${sum1+product.good.nowprice*product.count}"></c:set>
  <c:set var="num" value="${num+1}"></c:set>
      <tr align="center" valign="middle"> 
            <td height="27">${num}</td>
           <td ><a href="./showGdetail.do?gid=${product.good.gid}"><div id="name${num}" >${product.good.name}</div></a></td>
          <td style="text-decoration:line-through;">￥${product.good.marketprice }</td>
          <td style="color:#FF0000">￥${product.good.nowprice }</td>  
          <td ><fmt:formatNumber value="${ product.good.discount}" pattern="#.#"></fmt:formatNumber></td>
		 <td ><div id="num${num}"  onclick="javascript: return replace(${num})"   value="${product.count}">${product.count} </div></td> 
            <!--  数量测试
            <td ><input size="5" type="text" class="txt_grey" value="1"></td> 
             -->       
          <td ><img src="images/del.gif" width="25" height="25" onclick="back(${num})"></td>        
    </tr>
</c:forEach>
	      ...
	      <tr align="center" valign="middle">
            ...
            <td style="text-decoration:line-through;">￥${sum} </td>

            <td style="color:#FF0000">￥${sum1}  </td>
      ...
      <table width="100%" height="52" border="0" align="center" cellpadding="0" cellspacing="0">   
         ...
         <tr align="center" valign="middle">
           ...
           <td height="21" colspan="2"> <a href="index.jsp">继续购物</a> | <a href="javascript:checkUserLogInInterface('./getUserDetail.do')" >去收银台结账</a> | <a href="emptyCart.do">清空购物车</a></td>
