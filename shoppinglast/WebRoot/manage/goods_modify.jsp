<%@ page language="java" pageEncoding="UTF-8" import="java.util.*,com.shopping.guoguo.pojo.*,com.shopping.guoguo.dao.impl.*"%>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/global_guoguo_modify.js"></script>
...
<table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="${pageContext.request.contextPath}/images/manage_center_goodsmodi.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
        ...
        <tr>
          <td valign="top">
           <!-- start of the form -->
   			  	...
   			  	<form action="${pageContext.request.contextPath}/modifyGoods.do" method="post" name="form1"   enctype="multipart/form-data"   onSubmit="return checkSubmit();">
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  ...
                  <tr>
                    ...
                    <td colspan="3">&nbsp;
                      <input title="以下信息都不能为空哦！" name="name" type="text" class="modify" value="${good.name}" id="goodName" size="50" onblur="not_null('goodName','商品名称')"><span id="checkGoodsName"></span>&nbsp;&nbsp;                    </td>
                    </tr>
                  <tr>
                    <td height="30">&nbsp;市场价格：</td>
                    <td>&nbsp;
                          <input title="一定要是数字哦！" name="marketprice" type="text" value="${good.marketprice}" class="modify" id="price1"  onblur="not_null('price1','市场价格')">(元)
                    </td> 
                    <td>&nbsp;商城价格：</td>
                    <td>&nbsp;
                          <input title="不能大于市场价格哦，也要数字呢！" name="nowprice" value="${good.nowprice}" type="text" class="modify" id="price2" onblur="not_null('price2','商城价格')">(元)
                    </td>
                  </tr>
                  <tr>                    
                    <td height="30">&nbsp;折 扣 率：</td>
                    <td>&nbsp;
                          <input title="自动生成哦！" readonly="readonly" name="discount" type="text" value="<fmt:formatNumber value="${good.nowprice/good.marketprice*10}" pattern="#.#"/>" class="modify" id="price">
                    </td>
                    <td>&nbsp;是否特价：</td>
                    <td>
                    <c:if test="${good.bargain==1}">  <input name="bargain" type="radio" class="noborder" value="1" checked>是
                    <input name="bargain" type="radio" class="noborder" value="0">否 </c:if>
                    <c:if test="${good.bargain==0}"><input name="bargain" type="radio" class="noborder" value="1" >是
                    <input name="bargain" type="radio" class="noborder" value="0" checked>否 </c:if>
                  ...
                  <tr>
                    ...
                    <td colspan="3"><span class="style5">&nbsp; </span>
                       <input title="图片格式一定要为jpg哦！" class="modify" type="file" name="pricute" size=50>
                    </td>
                    <!-- 商品图片上传 -->
                  </tr>
                  <tr>
                    ...
                    <td colspan="3"><span class="style5">&nbsp; </span>
                        <textarea name="exp" cols="60" rows="5" class="textarea" id="introduce"  onblur="not_null('introduce','商品简介')">${good.exp}</textarea></td>
                  </tr>
                  <tr>
