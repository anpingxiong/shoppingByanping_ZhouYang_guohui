  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
   			  <form action="../addSorts.do?pid=0" method="post" name="form1">
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="30">大分类名称：</td>
					<td><input title="大分类名不能和已有的相同哦！" class="b_sort_add" name="name" type="text" id="typename" size="60"></td>
                  </tr> 
				  <tr>
                    <td width="16%" >描&nbsp;&nbsp;&nbsp;&nbsp;述</td>
                    <td width="84%" ><textarea title="描述要简明哦！"  class="b_sort_add" name="exp" cols="50" rows="5"></textarea></td>
                  </tr>
                  <tr align="center">
