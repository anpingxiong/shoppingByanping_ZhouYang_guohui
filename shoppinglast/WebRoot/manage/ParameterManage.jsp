...
<%@ include file="../include_head.jsp" %>
 ...
 request.getRequestDispatcher("../showBigSorts.do").forward(request, response);
 return;}%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>后台管理</title><!-- 获得所有大分类的名称编号 -->
      ...
      <table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0"> 
        <tr> 
          ...
          <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0"> 
              <tr> 
                <td valign="top" background="${pageContext.request.contextPath}/images/manage_center_superList.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0"> 
                    <tr> 
                      <td width="98%" align="right"><a href="${pageContext.request.contextPath}/manage/superType_add.jsp">[ <img src="../images/list.gif" width="11" height="13">&nbsp;添加大分类信息]</a></td> 
                      <td width="2%">&nbsp;</td> 
                    </tr> 
                </table></td> 
              </tr> 
                  ...
                  <td valign="top"> 
                    <table width="96%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF"> 
                      ...
                      <tr style="padding:5px;"> 
                        ...
                        <td align="center"><a href="${pageContext.request.contextPath}/showManageSorts.do?pid=${sort.sid}"><img src="${pageContext.request.contextPath}/images/modify.gif" width="15" height="15"></a></td>
                        <td align="center"><a href="${pageContext.request.contextPath}/showModifiedBigSort.do?sid=${sort.sid}"><img src="${pageContext.request.contextPath}/images/modify.gif" width="15" height="15"></a></td>
