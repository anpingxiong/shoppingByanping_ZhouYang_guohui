...
<!-- 操作菜单 -->
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="${pageContext.request.contextPath}/images/manage_center_goodsdetail.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
    ...
    <!-- table start -->
   <c:set value="${requestScope.good}" var="good"></c:set>
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
                   <table width="98%"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                   <tr>
                      <td colspan="2" class="font">${good.name} </td>
                    </tr>
                    <tr>
                      <td width="37%" rowspan="5" align="center"><img src="${pageContext.request.contextPath}/images/goods/${good.name}.jpg" width="150" height="100"></td>
                      <td width="63%">商品类型：[${good.sort.name }] </td>
                    </tr>
                    <tr>
                      <td>市场价：￥${good.marketprice}(元)</td>
                    </tr> 
                    <tr>
                      <td>商城价：￥${good.nowprice}(元) </td>
                    </tr>
                    <tr>
                      <td>折扣：<fmt:formatNumber value="${good.discount}" pattern="#.#"/></td>
                    </tr> 
                    <tr>
                      <td> 
                       <c:if test="${good.bargain==1}"><c:out value="特价商品"></c:out></c:if>
                       <c:if test="${good.bargain==0}"><c:out value=""></c:out></c:if>
                       </td>
                    </tr> 
                    ...
                    <tr>
                      <td colspan="2">&nbsp;&nbsp;${good.exp}</td>
                    </tr> 
                    <tr>
                       <td colspan="2"><hr align="center" size="1"></td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;&nbsp;创建人：bod12345  创建时间：${good.pdate}</td>
                    </tr>                   
                    <tr>
