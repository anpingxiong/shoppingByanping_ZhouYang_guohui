...
<%
List<Sort> sorts = (List<Sort>)request.getAttribute("sorts");
Sort bigSort = (Sort)request.getAttribute("bigSort");
if(sorts == null){
 request.getRequestDispatcher("../showManageSorts.do").forward(request, response);
 return;
}
 %>
 <!-- 这个页面中要获得一个大分类和对应小分类的名称 -->
      ...
      <table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0"> 
        <tr> 
          ...
          <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0"> 
              <tr> 
                <td valign="top" background="${pageContext.request.contextPath}/images/manage_center_subList.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0"> 
                    <tr> 
                      <td width="98%" align="right"><a href="./manage/subType_add.jsp?pid=${bigSort.sid}">[ <img src="${pageContext.request.contextPath}/images/list.gif" width="11" height="13">&nbsp;添加小分类信息]</a></td> 
                      <td width="2%">&nbsp;</td> 
                    </tr> 
                </table></td> 
              </tr> 
            </table> 
            <form action="${pageContext.request.contextPath }/manage/ParameterManage.jsp" method="post" name="frm"> 
              <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0"> 
                <tr> 
                  <td valign="top"> <table width="100%" height="14"  border="0" cellpadding="0" cellspacing="0"> </table> 
                    <table width="536" height="123"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#CCCCCC" bordercolorlight="#FFFFFF"> 
                      <tr bgcolor="#eeeeee"> 
                      ...
                      <c:set value="${num+1}" var="num"></c:set>
                        ...
                        <td height="20" align="center">${bigSort.name}</td>
                        <td height="20" align="center">${sort.name }</td>
                        <td align="center"><a href="${pageContext.request.contextPath }/showModifiedSmallSort.do?sid=${sort.sid }"><img src="${pageContext.request.contextPath}/images/modify.gif" width="15" height="15"></a></td>
                        <td align="center"><a href="${pageContext.request.contextPath }/deleteSort.do?sid=${sort.sid }"><img src="${pageContext.request.contextPath}/images/del.gif" width="16" height="16"></a></td>
                      </tr>  
                      </c:forEach>
              ...
              <input name="Submit" type="submit" class="button white small" onClick="history.back(-1);" value="返回">
            </form> 
