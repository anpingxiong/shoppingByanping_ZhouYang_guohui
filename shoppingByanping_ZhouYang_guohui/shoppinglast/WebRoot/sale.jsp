...
<c:if test="${empty pgoods}"><!-- 特价时 tag=1 -->
<jsp:forward page="./showGoodsPage.do?currentPage=1&tag=1"></jsp:forward>
</c:if>
<html>
<head>
<title>奋斗电子商城</title>
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
			  ...
			  <c:forEach items="${pgoods}" var="pgood">
                  <table width="98%" height="79"  border="0" cellpadding="0" cellspacing="0" class="noborder">
                    <tr>
                      <td width="37%" height="95" rowspan="4" align="center"><img src="images/goods/${pgood.name}.jpg" width="150" height="100"></td>
                      <td width="63%" height="27" class="font2"><a href="./showGdetail.do?gid=${pgood.gid}">${pgood.name}</a></td>
                    </tr>
                    <tr>
                      <td height="27" style="text-decoration:line-through;">市场价：￥${pgood.marketprice} </td>
                    </tr>
                    <tr>
                      <td height="27" style="color:#FF0000">商城价：￥${pgood.nowprice}(折扣：<fmt:formatNumber value="${pgood.discount}" pattern="#.#"></fmt:formatNumber>) </td>
                    </tr>                   
                    <tr>
                      <td><input type="button" class="button white small" value="购买" onClick="window.location.href='./cartAdd.do?gid=${pgood.gid}'">&nbsp;&nbsp;
           ...
           <table width="100%"  border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<a href="./showGoodsPage.do?currentPage=1&tag=1">第一页</a>　
				<a href="./showGoodsPage.do?currentPage=${vo.currentPage-1}&tag=1">上一页</a>
				<!-- 判断 如果currentPage已经等于totalpage那么 currentpage就等于totalpage -->
				<c:if test="${vo.currentPage!=vo.totalPage}" >
				<a href="./showGoodsPage.do?currentPage=${vo.currentPage+1}&tag=1">下一页</a>　
				</c:if>
				 <c:if test="${vo.currentPage==vo.totalPage}" >
				<a href="./showGoodsPage.do?currentPage=${vo.totalPage}&tag=1">下一页</a>　
				</c:if>
				<a href="./showGoodsPage.do?currentPage=${vo.totalPage}&tag=1">最后一页&nbsp;</a>
