...
<table width="777" height="288"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="top" background="${pageContext.request.contextPath}/images/manage_center_superAdd.gif"><table width="100%" height="36"  border="0" cellpadding="0" cellspacing="0">
          <tr>
          ...
          <!-- start of form -->
			    ...
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
					...
					<td><input title="分类名称要填写哦！" class="b_sort" name="name" type="text" id="typename" size="60" value="${sort.name }"></td>
                  </tr> 
				  <tr>
                    <td width="16%" >描&nbsp;&nbsp;&nbsp;&nbsp;述</td>
                    <td width="84%" ><textarea title="详细点哦！" name="exp" cols="50" rows="5" class="b_sort">${sort.exp}</textarea></td>
                  </tr>
                  <tr align="center">
