  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%" height="120"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="92%" height="192"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td valign="top">
   			  <form action="../updateNotice.do" method="post" name="form1"  onsubmit="return checkOverDateToPdate();">
   			  <input type="hidden" name="id" value="<%=request.getParameter("id") %>">
			  
			    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  <tr>
                    <td height="30">公告标题：</td>
					<td><input name="title" type="text"  size="60" id="title"  ></td>
                  </tr> 
				  <tr>
                    <td width="14%" >&nbsp;公告内容：</td>
                    <td width="86%">
                        <textarea name="content" cols="60" rows="15"   id="content" class="text"></textarea></td>
                  </tr> 
                  <tr>
                    <td height="30">发布时间：</td>
					<td>
				        <span id="pdate"   name="pdate"></span>
					</td>
                  </tr> 
                  <tr>
                    <td height="30">失效时间：</td>
					<td>
					   <input type="text" class="biuuu2" name="overDate"  size="60" id="overDate"  title="注意失效时间不能超过发布时间" />   
                    </td>
                  </tr>                   
                  <tr>
                    <td height="25" colspan="2" align="center">
                        <input name="Button" type="submit" class="button white  bigrounded " value="保存"  >
                        &nbsp;                        
                        <input name="Submit2" type="reset" class="button white  bigrounded " value="重置">
                        &nbsp;
                        <input name="Submit3" type="button" class="button white  bigrounded " value="返回" onClick="JScript:history.back()">
                    </td>
                  </tr>
                </table>
			  </form>
